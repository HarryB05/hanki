      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="p-6">
          <div className="flex justify-between items-center mb-6">
            <div>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Create New Deck</h2>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">CSV file: {filename}</p>
            </div>
            <button
              onClick={onClose}
